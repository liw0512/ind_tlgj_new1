...
EXPERIENCE_SOURCE_TEXT = {
    ...
    "SUPPLY_FLOW_PROTOTYPE": "历史供浆流量原型",
}
...
REASON_TEXT = {
    "FLOW_PROTOTYPE_SELECTED": "已匹配满足门槛的历史供浆流量原型",
    "NO_ACCEPTED_FLOW_PROTOTYPE": "当前工况没有满足可靠性和安全门槛的供浆流量原型",
    "CANONICAL_OUTPUT:TARGET_SUPPLY_FLOW": "第二模块规范输出为目标供浆流量",
    # FAST_CHANGE 趋势与状态机
    ...
    # 目标供浆流量影子验证 / DRY_RUN
    "FLOW_CANDIDATE_UNAVAILABLE": "当前没有可用的目标流量候选",
    "FLOW_METER_SET_INCOMPLETE": "供浆流量计数据不完整，无法形成可靠总流量",
    "TOWER_PH_OUTSIDE_SAFE_RANGE": "浆液 pH 不在安全范围内，目标流量预演已阻断",
    "TARGET_FLOW_NOT_FINITE": "目标供浆流量不是有效数值",
    "TARGET_FLOW_DIRECTION_INCONSISTENT": "目标流量方向与本次供浆方向不一致",
    "FINAL_TARGET_EVIDENCE_RANGE_MISSING": "历史原型缺少最终流量证据范围",
    "PEAK_TARGET_EVIDENCE_RANGE_MISSING": "历史原型缺少峰值流量证据范围",
    "TARGET_FLOW_TOLERANCE_INVALID": "目标流量完成容差无效",
    "ENGINEERING_FLOW_LIMITS_NOT_CONFIGURED": "尚未配置并核验工程流量硬边界",
    "DRY_RUN_NO_DCS_WRITE": "当前仅做 DRY_RUN 预演，不会向 DCS 写入指令",
    "INSUFFICIENT_EVALUATED_PLANS": "影子验证的已评估计划数量不足",
    "INSUFFICIENT_OBSERVED_DAYS": "影子验证覆盖的运行天数不足",
    "FLOW_COMPLETION_RATE_BELOW_THRESHOLD": "目标流量轨迹完成率未达到门槛",
    "EFFECT_PROFILE_COMPLETE_RATE_BELOW_THRESHOLD": "SO₂ / pH 效果观测完整率未达到门槛",
    "DIRECTION_MATCH_RATE_BELOW_THRESHOLD": "实际效果方向一致率未达到门槛",
    "SAFETY_PASS_RATE_BELOW_THRESHOLD": "影子验证安全通过率未达到门槛",
    "TIMEOUT_RATE_ABOVE_THRESHOLD": "目标流量跟踪超时率超过门槛",
}
